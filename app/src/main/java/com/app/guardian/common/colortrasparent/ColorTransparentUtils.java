package com.app.guardian.common.colortrasparent;
...
public class ColorTransparentUtils {
    ...
    public static String transparentColor(String colorCode, int trans) {
     ...
     */
    public static String convertIntoColor(String colorCode, int transCode) {
