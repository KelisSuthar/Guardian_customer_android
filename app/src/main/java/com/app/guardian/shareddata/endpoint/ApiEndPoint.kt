...
//    fun getKey(): Call<CommonResponseModel<KeyData>>
    ...
    fun updateUserProfile(@Body jsonObject: JsonObject): Call<CommonResponseModel<UserDetailsResp>>
    ...
    fun deleteUploadedVideos(@Path("id") id: Int): Call<CommonResponseModel<CommonResponse>>
